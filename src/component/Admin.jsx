...
function Login({ setLoggedIn }) {
  ...
  return (
    <>
      <div className="login">
        <h1>Login Form</h1>
        <input type="text" id='loginu' placeholder="Enter user name" value={user} onChange={(e) => setUser(e.target.value)} />
        <br />
        <input type="password" id='loginp' placeholder="Enter password" value={password} onChange={(e) => setPassword(e.target.value)} />
        <br />
        <button id='loginb' onClick={handleSubmit}>Submit</button>
      </div>
      <section id='row23'>
    <div className="row6">
